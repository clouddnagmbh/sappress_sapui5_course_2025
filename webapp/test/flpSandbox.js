		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Customer Mgmt.",
									"targetURL": "#comsappresscustomerapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsappresscustomerapp-display": {
								"semanticObject": "comsappresscustomerapp",
								"action": "display",
								"description": "An SAP Fiori application for managin customers.",
								"title": "Customer Mgmt.",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sappress.customerapp",
									"url": sap.ui.require.toUrl("com/sappress/customerapp")
								}
							}
						}
					}
